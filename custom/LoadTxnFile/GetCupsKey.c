...
KeyFunc g_KeyFun[] = {
		...
		{"cntn",  nCntpLocalLoad, "组织银视通新平台对账KEY值"},
		...
		{"ysea",  nYsepLocalLoad, "组织银盛支付对账KEY值"},
		{"tlpy",  nTlpyLocalLoad, "组织通联支付KEY值"},
		{"hdsy",  nHdsyLocalLoad, "组织宏达上叶KEY值"},
		{"hdsx",  nHdsyLocalLoad, "组织宏达上叶KEY值"},
		{"wfjn",  nWfjpLocalLoad, "组织王府井新平台KEY值"},
		{"wfja",  nWfjpLocalLoad, "组织王府井虚拟通道KEY值"},
		{"cdif",  nCdifLocalLoad, "组织卡友平台KEY值"},
		{"cdia",  nCdifLocalLoad, "组织卡友虚拟平台KEY值"}
};
